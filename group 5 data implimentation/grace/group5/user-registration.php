...
if (!empty($_POST["signup-btn"])) {
	...
	$con = mysqli_connect("localhost", "root", "root", "facebook");
	$query = mysqli_query($con, "insert into user values(null ,'$name' ,'$email' ,'$password' ,$phone ,$age)");
			...
			<div class="">
				<form name="sign-up" action="" method="post" onsubmit="return signupValidation()">
					...
					<div class="row">
						<div class="inline-block">
							<div class="form-label">
								Phone number<span class="required error" id="email-info"></span>
							</div>
							<input class="input-box-330" type="number" name="phone" id="number">
						</div>
					</div>
					<div class="row">
						<div class="inline-block">
							<div class="form-label">
								Age <span class="required error" id="email-info"></span>
							</div>
							<input class="input-box-330" type="number" name="age" id="age">
						</div>
					</div>
					<div class="row">
						<div class="inline-block">
