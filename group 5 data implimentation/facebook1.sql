...
CREATE TABLE `comment_like` (
  ...
  KEY `fk_comment_like` (`id_user`),
  KEY `fk_comment_like2` (`id_comment`),
  CONSTRAINT `fk_comment_like` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`),
...
CREATE TABLE `follower` (
  ...
  CONSTRAINT `fk_user_follower` FOREIGN KEY (`id_followed`) REFERENCES `user` (`id_user`),
  CONSTRAINT `fk_user_follower2` FOREIGN KEY (`id_follower`) REFERENCES `user` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `post` (
  ...
  CONSTRAINT `fk_user_post` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `post_like` (
  ...
  KEY `fk_post_like` (`id_user`),
  KEY `fk_post_like2` (`id_post`),
  CONSTRAINT `fk_post_like` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`),
